  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      plugin = {
        dynamic-cursors = {
          # enables the plugin
          ## FIX: DISABLED due to some incompability
          enabled = false;
        ...
        # configure shake to find magnifies the cursor if its is being shaken
        shake = {
          enabled = true;
          ...
          limit = 0.0; # values below 1 disable the limit (e.g. 0)
